...
ALARM_PATH := vendor/cygnus/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/cygnus/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/cygnus/prebuilt/common/media/audio/ringtones
